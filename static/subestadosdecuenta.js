document.addEventListener('DOMContentLoaded', function () {
    ...
    fetch(`/listar_SEC/${userId}/${idTF}/${TipoTC}`)
        ...
        .then(empleados => {
            ...
            empleados.forEach(empleado => {
                ...
                row.innerHTML = `
                    ...
                    <td>${empleado.Compras}</td>
                    <td>${empleado.SumaCompras}</td>
                    <td>${empleado.Retiros}</td>
                    <td>${empleado.SumaRetiros}</td>

                    <td>
                        <button onclick="window.location.href='/movimientos/${empleado.Id}/${'TCA'}'">Movimientos</button>
                    </td>
                `;
